...
export default function ShopProductDetail({ route, navigation }) {
  ...
  if (productInfo) {
    ...
    var shipping =
      productInfo.shipping && parseFloat(productInfo.shipping).toFixed(2);
      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: () => {
            ...
            fetch(
              "https://pgmarket.online/api/destroyProduct/" + item.id,
              requestOptions
            )
              .then((response) => response.json())
              .then((result) => {
      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: () => {
            ...
            fetch(
              "https://pgmarket.online/api/updateStatus/" + item.id,
              requestOptions
            )
              .then((response) => response.json())
              .then((result) => {
    ...
    <ScrollView>
      ...
      >
        <TouchableOpacity
          ...
          style={{
            backgroundColor: productStatus == 1 ? colors.warning : "tomato",
            alignItems: "center",
        ...
        <Button title="images" bgColor={colors.medium} onPress={addImages} />
      </View>
        ...
        <View style={{ padding: 10 }}>
          ...
          {productMainCategory && (
            <LabelValue
              ...
              value={
                i18n.language == "en"
                  ? productMainCategory.name_en
                  : productMainCategory.name_kh
              }
            />
          )}
          {productCategory && (
          ...
          <LabelValue
            label="brand"
            value={productBrand ? productBrand.name : "N/A"}
          />
          <LabelValue
            label="shipping"
            value={shipping ? shipping : "Free Delivery"}
          />
