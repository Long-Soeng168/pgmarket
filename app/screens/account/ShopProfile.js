...
export default function ShopProfile({ navigation, route }) {
  ...
  React.useEffect(() => {
    const fetchDataAsync = async () => {
      await fetchData(
        "https://pgmarket.online/api/shopview/" + user.user.id,
        setShop
      );
      setIsFetching(false);
    };
  ...
  const bannerUrl =
    shop &&
    "https://pgmarket.online/public/images/shop_banner/" + shop.image_banner;
  const imageUrl =
    shop && "https://pgmarket.online/public/images/shop/" + shop.image;
  const shopName = shop && shop.shop_name;
  const shopAddress = shop && shop.shop_address;
  const shopNumber = shop && shop.shop_phone;
  const telegramLink = shop && shop.telegram_link;
          ...
          <ScrollView>
            ...
            <View style={{ marginBottom: 100 }}>
              ...
              <View>
                <View style={styles.profile}>
                  ...
                  <Text style={styles.profileTitle}>{shopName}</Text>
                </View>
              </View>
            </View>
            ...
            {selected === "Products" ? (
                    ...
                    <FlatList
                      ...
                      renderItem={({ item }) => (
                        <TouchableOpacity
                          key={item.pro_id}
                          onPress={() =>
                            navigation.push("ShopProductDetail", item)
                          }
                        >
                          <CardProduct
                            item={item}
              ...
              <View style={{ padding: 10, gap: 15 }}>
                ...
                <AboutItem title="email" detail={shopEmail} icon="envelope-o" />
                <AboutItem
                  title="description"
                ...
                <View style={{ flexDirection: "row" }}>
                  ...
                  <TouchableOpacity
                    style={[styles.AddButton, { backgroundColor: "tomato" }]}
